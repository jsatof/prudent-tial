...
public class Crosshair : MonoBehaviour {
	...
	//	hoveredTile = World.Tile((int)transform.position.x, (int)transform.position.y);
		...
		// Check Mouse Clicks: Left Click: Select, Right Click: Back
		if(Input.GetMouseButtonDown(0)) { // Left Mouse Click
			// send data to click manager
		}
